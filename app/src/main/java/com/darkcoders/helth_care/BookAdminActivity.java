...
public class BookAdminActivity extends AppCompatActivity implements ValueEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // t=findViewById(R.id.text);
        ...
        d1.show();
        d_ref = FirebaseDatabase.getInstance().getReference().child("Books");
       ...
       // View view;
       // Toast.makeText(view.getContext(),"Please Wait until the file is download",Toast.LENGTH_LONG).show();
        downloadManager = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);

        myAdapter = new MyAdapter(this, file, date,listuri,admin,d_ref,downloadManager);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            AlertDialog.Builder a = new AlertDialog.Builder(BookAdminActivity.this);
            a.setTitle("SAVE AS");
        ...
        filepath.putFile(imageuri).continueWithTask(new Continuation() {
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(BookAdminActivity.this, "Uploaded Successfully ", Toast.LENGTH_SHORT).show();
                } else {
                    dialog.dismiss();
                    Toast.makeText(BookAdminActivity.this, "UploadedFailed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
