...
public class MyAdapter extends ArrayAdapter<String> {
    ...
    public MyAdapter(@NonNull Activity activity, ArrayList<String> list_file, ArrayList<String> list_date,
                     ArrayList<String> list_url, String admin, DatabaseReference d_ref, DownloadManager downloadManager) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
       ...
       viewHolder. cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                a.setMessage("Are You Sure,You want to Download " +list_file.get(position)+" book?");
                a.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        String urls=list_url.get(position);
                        ...
                        request.setDestinationInExternalFilesDir(view.getContext(), Environment.DIRECTORY_DOWNLOADS, "/"+ filename);
